...
import static com.imcub.imcubApp.R.drawable.ic_person_black_24dp;
...
public class Activity_Cadastro_Usuario extends AppCompatActivity {
    ...
    View.OnClickListener selecionarimagem = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try {
                ...
                Toast.makeText(Activity_Cadastro_Usuario.this,"Nada"+ne,Toast.LENGTH_LONG).show();
            }
    ...
    private void criarUser(String email,String senha) {
        try {
            ...
            Toast.makeText(Activity_Cadastro_Usuario.this,"Erro"+e,Toast.LENGTH_LONG).show();
    ...
    private void uploadimg() {
        try {
            ...
            Toast.makeText(Activity_Cadastro_Usuario.this,"Nenhuma foto de perfil selecionada",Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0) {
            try {
                ...
                Toast.makeText(Activity_Cadastro_Usuario.this,"Preencha todos os campos",Toast.LENGTH_LONG).show();
